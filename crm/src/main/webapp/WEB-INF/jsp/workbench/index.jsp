...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // 工作台首页面显示
            window.open("workbench/toWorkbench.do", "workareaFrame");
        ...
        <ul>
            <li class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu" style="margin: 0px -63px;min-width:138px;">
                    ...
                    <li><a  data-toggle="modal" data-target="#editPwdModal"><span
                            class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
                    <%--
                        data-toggle="modal" ,触发的是模态窗口model
                        data-target="#exitModal" ,打开的是哪个模态窗口
                        模态窗口时由div标签组成，好处：自带动画和渐变效果，用户感受良好
                    --%>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="workbench/toWorkbench.do" target="workareaFrame"><span
            ...
            <%--查询全部市场活动数据-未分页--%>
            <%--
            <li class="liClass"><a href="workbench/activity/toindex.do" target="workareaFrame">
